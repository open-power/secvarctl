...
size_t
get_leading_whitespace (unsigned char *data, size_t dataSize)
{
...
void
print_hex (unsigned char *data, size_t length)
{
  int i;
 ...
 */
void
print_raw (const char *c, size_t size)
{
 ...
 */
char *
get_data_from_file (const char *fullPath, size_t max_bytes, size_t *size)
{
  int fptr;
  char *buffer = NULL;
 ...
 */
int
write_data_to_file (const char *file, const char *buff, size_t size)
{
  int rc, fptr;
 ...
 */
int
create_file (const char *file, const char *buff, size_t size)
{
  int rc, fptr;
 ...
 */
int
realloc_array (void **arr, size_t new_length, size_t size_each)
{
  void *old_arr;
  size_t new_size;
