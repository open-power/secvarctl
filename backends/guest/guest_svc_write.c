  ...
  switch (key)
    {
      ...
      case 'f': args->input_valid = 1; break;
      case 'v': verbose = PR_DEBUG; break;
      case ARGP_KEY_ARG:
 ...
 */
int
guest_write_command (int argc, char *argv[])
{
  int rc;
  struct write_args args = {
    .help_flag = 0, .input_valid = 0, .path = NULL, .input_file = NULL, .variable_name = NULL
  };
